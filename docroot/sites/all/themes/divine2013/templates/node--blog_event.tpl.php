...
<a href="http://example.com/link-to-your-event" title="Add to Calendar" class="addthisevent">
    Add to Calendar
    <span class="_url"><?php print $node_url; ?></span>
    <span class="_start"><?php print $node->field_event_date[$node->language][0]['value']; ?></span>
    <span class="_end"><?php print $node->field_event_date[$node->language][0]['value2']; ?></span>
