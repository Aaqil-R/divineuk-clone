...
<div class="product-display-image">
    <div class="field-offers">
	 ...
	 <?php if (!empty($content['product:field_offers'])): ?>
        ...
        <?php else (!empty($content['product:field_new_addition'])): ?>
            <div class="product-offer-<?php print render($content['product:field_new_addition']['#items'][0]['tid']); ?>"></div> 
        <?php else (!empty($content['product:field_shipping_offer'])): ?>
  ...
  ?>
  <div class="social-share facbook">
    <div class="fb-like" data-send="true" data-show-faces="true" data-width="300">&nbsp;</div>
  </div>
  <div class="social-share google-plus"><!-- Place this tag where you want the +1 button to render. -->
    <div class="g-plusone" data-annotation="inline" data-size="tall" data-width="300">&nbsp;</div>
  </div>

</div>
<div class="wrapper<?php if (isset($content['product:field_out_of_stock']['#field_name'])) print ' disabled'; ?>">
