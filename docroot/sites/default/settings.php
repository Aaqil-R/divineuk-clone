 ...
 *
 */
$drupal_hash_salt = 'IBvCuwJJF8flbW9T4EF7mc9wRlDVvejn_pqWfowe63g';
...
/** 
 * Context_Mobile requirement
 *
 * When the drupal page cache is enabled the following line needs to be added to the end of settings.php:
 * so that the CONTEXT_MOBILE module works correctly
 */
include DRUPAL_ROOT . '/sites/all/modules/context_mobile_detect/settings.inc';

/**
 * This fixes an issue in the Responsive images & styles - http://drupal.org/project/resp_img
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_divineuk_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_divineuk_dev_default.inc';
}
// </DDSETTINGS>
